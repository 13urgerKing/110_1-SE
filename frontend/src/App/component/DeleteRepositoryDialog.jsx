...
export default function DeleteRepositoryDialog({ open, reloadProjects, handleClose, projectId}) {
    ...
    const deleteRepository = () => {
      ...
      Axios.post(`http://localhost:9100/pvs-api/project/delete/repository/${type}`, payload,
